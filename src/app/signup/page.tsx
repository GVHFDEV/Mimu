    ...
    return (
      <div className="min-h-screen flex">
        ...
        <div className="w-full lg:w-1/2 bg-gradient-to-br from-[#F5F5F0] via-[#F5F5F0] to-[#A6B89E]/10 flex flex-col">
          ...
          <main className="flex-1 flex items-center justify-center px-6 lg:px-12 py-6">
            <div className="w-full max-w-md">
              ...
              >
                {/* Success Card */}
                <motion.div
                  className="bg-white rounded-3xl shadow-xl p-5 md:p-6 border border-[#4F6D45]/10"
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-xs md:text-sm text-[#1A1A1A]/70 font-sans mb-2">
                    ...
                    <div className="mt-8 pt-4 border-t border-[#4F6D45]/10">
                      <Link
                        href="/login"
          ...
          {/* Footer */}
          <footer className="mt-4 px-6 lg:px-12 flex justify-center pb-6">
            <div className="w-full max-w-md">
              <div className="border-t border-[#4F6D45]/5 pt-4">
          ...
          <div className="w-full max-w-md">
            ...
            >
              ...
              <motion.div className="text-center mb-5" variants={itemVariants}>
                <h1 className="text-2xl md:text-3xl font-bold text-[#4F6D45] mb-2 font-display">
                  Crie sua conta
                </h1>
                <p className="text-xs md:text-sm text-[#1A1A1A]/70 font-sans">
              ...
              >
                <form action={handleSubmit} className="space-y-4">
                  <motion.div variants={itemVariants}>
                    <label
                      htmlFor="username"
                      className="block text-xs font-medium text-[#1A1A1A] mb-1.5 font-sans"
                    >
                      Nome
                    </label>
                    <input
                    ...
                    required
                    disabled={isPending}
                    className={`w-full px-3 py-2.5 min-h-[44px] rounded-xl bg-white border-2 transition-all duration-200 text-sm shadow-sm ${
                      errors.username
                  ...
                  {errors.username && (
                    <motion.p
                      className="mt-1.5 text-xs text-red-500 font-sans flex items-center gap-1"
                ...
                {errors.general && (
                  <motion.div
                    className="p-2.5 rounded-2xl bg-red-50 border border-red-200"
                ...
                <motion.button
                  ...
                  variants={itemVariants}
                  className="w-full py-2.5 px-5 min-h-[44px] rounded-2xl bg-gradient-to-r from-[#4F6D45] to-[#A6B89E] text-white text-sm font-medium hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-[#4F6D45]/20 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-sans flex items-center justify-center gap-2"
                >
                  {isPending ? (
                    <>
              ...
              <p className="text-xs text-[#1A1A1A]/70 font-sans">
                ...
                <motion.div className="relative my-4" variants={itemVariants}>
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white px-3 text-[#1A1A1A]/50 font-sans">ou</span>
                  </div>
                </motion.div>
              ...
              whileHover={{ scale: 1.02 }}
              variants={itemVariants}
              className="w-full py-2.5 px-5 min-h-[44px] rounded-2xl bg-white text-[#1A1A1A] text-sm font-medium hover:bg-white/90 focus:outline-none focus:ring-4 focus:ring-[#4F6D45]/20 transition-all duration-200 shadow-md hover:shadow-lg border border-[#4F6D45]/10 font-sans flex items-center justify-center gap-2"
            >
              ...
              Entrar com Google
                ...
                <motion.p className="text-center mt-4 text-xs text-[#1A1A1A]/50 font-sans" variants={itemVariants}>
