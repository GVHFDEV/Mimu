...
DROP POLICY IF EXISTS "Users can view their pets' health events" ON health_events;
DROP POLICY IF EXISTS "Users can insert health events for their pets" ON health_events;
DROP POLICY IF EXISTS "Users can update their pets' health events" ON health_events;
DROP POLICY IF EXISTS "Users can delete their pets' health events" ON health_events;
...
SELECT 'Tabela health_events criada com sucesso!' as status;
SELECT COUNT(*) as total_policies FROM pg_policies WHERE tablename = 'health_events';
